...
class NotifyHelper {
  ...
  tz.TZDateTime _nextInstanceOfTenAM(
    ...
    final tz.TZDateTime formatDateNow =
        tz.TZDateTime.from(formattedDate, tz.local);

    tz.TZDateTime scheduledDate = tz.TZDateTime(tz.local, formatDateNow.year,
        formatDateNow.month, formatDateNow.day, hour, minutes);
